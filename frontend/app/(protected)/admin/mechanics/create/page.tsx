...
export default function CreateMechanicPage() {
  ...
  return (
    <>
      <AdminHeader title="Tambah Mekanik" description="Daftarkan mekanik baru ke dalam sistem." />
          ...
          <div className="p-8 flex-1 overflow-y-auto custom-scrollbar">
            <div className="space-y-8">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <h2 className="text-3xl font-black tracking-tighter uppercase italic">
                    Tambah <span className="text-primary">Mekanik</span>
                  </h2>
                  <p className="text-slate-500 text-sm font-medium">
                    Lengkapi data mekanik baru di bawah ini.
                  </p>
                </div>
                <Button 
                  variant="outline" 
              ...
              <div className="bg-slate-50 dark:bg-slate-800/50 p-6 rounded-3xl border border-slate-100 dark:border-white/5">
                <MechanicForm onClose={handleClose} />
              </div>
            </div>
          </div>
        </div>
