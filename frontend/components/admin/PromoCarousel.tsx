      ...
      >
        <CarouselContent className="-ml-4">
          ...
          <CarouselItem className="pl-4 basis-[90%] md:basis-[100%] lg:basis-[85%]">
            <Card className="w-full h-[180px] overflow-hidden border-0 bg-[#16181D] rounded-[24px] shadow-lg relative cursor-pointer group">
              <div className="flex items-stretch h-full">
                <div className="flex-1 p-6 flex flex-col justify-center z-10 relative">
                  ...
                  <div className="relative z-10 group-hover:translate-x-1 transition-transform duration-300">
                    ...
                    <div className="text-[#FFC107] font-black text-5xl sm:text-6xl leading-none mb-1">
          ...
          {/* Card 2 */}
          <CarouselItem className="pl-4 basis-[90%] md:basis-[100%] lg:basis-[85%]">
            <Card className="w-full h-[180px] overflow-hidden border-0 bg-emerald-950 rounded-[24px] shadow-lg relative cursor-pointer group">
              <div className="flex items-stretch h-full">
                <div className="flex-1 p-6 flex flex-col justify-center z-10 relative">
